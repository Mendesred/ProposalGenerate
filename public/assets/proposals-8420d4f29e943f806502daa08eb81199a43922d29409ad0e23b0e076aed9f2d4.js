...
(function() {
  var check_radio, check_value, hash, lista_html_equip, lista_html_sub_type;
  ...
  jQuery(function() {
    var elemTypes, equipaments, equipaments2, escaped_type, i, results, subType, subType2, type;
  ...
  check_value = function(obj_select, obj_collapse) {
    if (obj_select.val() === '1') {
  ...
  $(document).on('change', '#proposal_h_extra_jornada_all', function() {
    check_value($('#proposal_h_extra_jornada_all'), $('#hExtraSim'));
  });

  $(document).on('change', '#proposal_h_extra_refeicao_all', function() {
    check_value($('#proposal_h_extra_refeicao_all'), $('#hExtraAllAlmoco'));
  });

  $(document).on('change', '#proposal_h_extra_jornada_matu', function() {
    check_value($('#proposal_h_extra_jornada_matu'), $('#hExtraMatutinoJornada'));
  });

  $(document).on('change', '#proposal_h_extra_refeicao_matu', function() {
    check_value($('#proposal_h_extra_refeicao_matu'), $('#almocoExtraMatutinoAlmoco'));
  });

  $(document).on('change', '#proposal_h_extra_jornada_vesp', function() {
    check_value($('#proposal_h_extra_jornada_vesp'), $('#hExtraVespertinoJornda'));
  });

  $(document).on('change', '#proposal_h_extra_refeicao_vesp', function() {
    check_value($('#proposal_h_extra_refeicao_vesp'), $('#hExtraVespertinoAlmoco'));
  });

  $(document).on('change', '#proposal_h_extra_jornada_notur', function() {
    check_value($('#proposal_h_extra_jornada_notur'), $('#hExtraNoturnoJornada'));
  });

  $(document).on('change', '#proposal_h_extra_refeicao_notur', function() {
    check_value($('#proposal_h_extra_refeicao_notur'), $('#hExtraNoturnoAlmoco'));
  });

  $(document).on('change', '#proposal_vr_all', function() {
    check_value($('#proposal_vr_all'), $('#allDiasVR'));
  });

  $(document).on('change', '#proposal_vr_matu', function() {
    check_value($('#proposal_vr_matu'), $('#matutinoVr'));
  });

  $(document).on('change', '#proposal_vr_vesp', function() {
    check_value($('#proposal_vr_vesp'), $('#vespertinoVrOption'));
  });

  $(document).on('change', '#proposal_vr_notur', function() {
    check_value($('#proposal_vr_notur'), $('#noturnoVrOption'));
  });

  $(document).on('change', '#proposal_vt_all', function() {
    check_value($('#proposal_vt_all'), $('#allDiasVT'));
  });

  $(document).on('change', '#proposal_vt_matu', function() {
    check_value($('#proposal_vt_matu'), $('#peridMatutinoJornada'));
  });

  $(document).on('change', '#proposal_vt_vesp', function() {
    check_value($('#proposal_vt_vesp'), $('#periodVespJornada'));
  });

  $(document).on('change', '#proposal_vt_notur', function() {
  ...
  check_radio = function(obj_select_radio1, obj_select_radio2, obj_collapse1, obj_collapse2) {
    var ref, ref1;
    if ((ref = document.getElementById(obj_select_radio1.attr('id'))) != null ? ref.checked : void 0) {
      obj_collapse1.collapse('show');
      obj_collapse2.collapse('hide');
    }
    if ((ref1 = document.getElementById(obj_select_radio2.attr('id'))) != null ? ref1.checked : void 0) {
  ...
  $(document).on('change', '#type', function() {
    var escaped_type, options, subType, type;
  ...
  $(document).on('change', '#subType', function() {
    var equipaments, escaped_type, options, subType;
  ...
  $(document).on('change', '#proposal_radio_h_extra_all', function() {
    check_radio($(this), $('#proposal_radio_h_extra_parcial'), $('#tab_all'), $('#tab_parcial'));
  });

  $(document).on('change', '#proposal_radio_h_extra_parcial', function() {
  ...
  $(document).on('change', '#proposal_radio_vr_extra_all', function() {
    check_radio($(this), $('#proposal_radio_vr_extra_parcial'), $('#tab_all_vr'), $('#tab_parcial_vr'));
  });

  $(document).on('change', '#proposal_radio_vr_extra_parcial', function() {
  ...
  $(document).on('change', '#proposal_radio_vt_extra_all', function() {
    check_radio($(this), $('#proposal_radio_vt_extra_parcial'), $('#tab_all_vt'), $('#tab_parcial_vt'));
  });

  $(document).on('change', '#proposal_radio_vt_extra_parcial', function() {
